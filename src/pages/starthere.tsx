...
export const Starthere = () => {
  ...
  return (
    <>
      <SEO
        title="Start Here - Your Journey to Digital Marketing Success"
        description="Begin your digital marketing transformation with Detoplea Marketing. Learn about our proven process, meet our expert team, and discover how we help businesses achieve remarkable online growth and success."
        keywords="start digital marketing, marketing consultation, meet our team, digital marketing process, business transformation, marketing strategy, online growth journey"
        url="https://detoplea.com/starthere"
        type="website"
      />
        ...
        >
          <div className="flex whitespace-nowrap animate-marquee2">
            <h2 className="text-white text-2xl sm:text-4xl md:text-7xl uppercase font-normal mr-8">
              ...
              Marketing Agency // Welcome to Detoplea Marketing Agency //
              Welcome to Detoplea Marketing Agency // Welcome to Detoplea
              Marketing Agency // Welcome to Detoplea Marketing Agency //
            </h2>
          </div>
