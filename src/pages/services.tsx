...
export const Services = () => {
  ...
  return (
    <>
      <SEO
        title="Digital Marketing Services - SEO, Social Media & Web Design"
        description="Comprehensive digital marketing services including SEO optimization, social media marketing, web design, content creation, and brand strategy. Get professional marketing solutions that drive real business results."
        keywords="digital marketing services, SEO services, social media marketing, web design services, content marketing, brand strategy, online advertising, marketing consultation, business growth services"
        url="https://detoplea.com/services"
        type="website"
      />
      <div className="mt-12 md:mt-12">
        ...
        <div className="mt-6 md:mt-10 flex flex-col justify-center w-full mb-6 md:mb-10">
          ...
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="flex flex-col px-4 md:px-60 py-3 md:py-5"
            >
              <div
