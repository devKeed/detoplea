...
import { InputField, TextAreaField, CheckboxField, SelectField } from "../components/reusables/ContactComponents";
...
export const Contact = () => {
  ...
  const validateForm = () => {
    ...
    const hasSelectedService = Object.values(formData.selectedServices).some(value => value);
  ...
  return (
    <div className="py-5 sm:py-16 lg:py-20">
      <div className="my-5 sm:my-20 lg:my-44">
        ...
        <form onSubmit={handleSubmit} className="pt-5 px-6 sm:px-12 lg:px-16 flex flex-col gap-5">
          {/* Basic Info Section */}
          ...
          <div className="flex flex-col pt-5 sm:pt-16">
            <p className="">What service(s) are you interested in? <span className="text-red-500">*</span></p>
            {errors.selectedServices && (
              <p className="text-red-500 text-xs mt-1">{errors.selectedServices}</p>
            )}
          ...
          <div className="flex flex-col pt-8">
            <div className="flex items-center gap-3">
              <p className="">What is your monthly budget? <span className="text-red-500">*</span></p>
            ...
            {errors.selectedBudget && (
              <p className="text-red-500 text-xs mt-1">{errors.selectedBudget}</p>
            )}
